...
String t ;
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "User Details", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial Black", 1, 12), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        jPanel4.add(deleteuser, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 10, -1, -1));
        ...
        jPanel4.add(adduser, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 100, -1));
        ...
        jPanel4.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 50, 90, -1));
        ...
        jPanel4.add(updateuser, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 10, -1, -1));
        ...
        jPanel4.add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 50, -1, -1));

        jPanel1.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(26, 490, 400, 100));
...
month.getSelectedIndex()==0||year.getSelectedIndex()==0||address.getText().equals("")||
    phone.getText().equals("")|| salary.getText().equals("") || password.getText().equals("") ){
  JOptionPane.showMessageDialog(null,"Complete Your Information","Missing Information",2); 
}
else if(!checkid()){
    if(password.getText().length()<6){
  JOptionPane.showMessageDialog(null,"User Password Should be at least 6 Characters","Wrong Operation",2);
    }else {
